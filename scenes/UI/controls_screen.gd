...
var story_module_scene: PackedScene = load("res://scenes/UI/menu_modules/story_module.tscn")
...
func _ready():
	...
	story_mode_item.set_text(0, "Story")
...
func item_was_selected():
	...
	match current_item.get_text(0):
		"Story":
			...
			current_screen = story_module_scene.instantiate()
